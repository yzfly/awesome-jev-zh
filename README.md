...
<!-- HOT:START -->
> 🤖 由 [`scripts/collect_hot.py`](scripts/collect_hot.py) 每日自动抓取并排序，最后更新：**2026-09-24**（UTC）。收录规则：2026-09-10 之后创建、名称/描述/README 命中 Jev 生态关键词、Star ≥ 3，外加 [`typesafe-ai`](https://github.com/typesafe-ai) 官方组织全量。`🆕` = 本周新进榜，`▲` = 相比上次抓取的 Star 增量。

| # | 项目 | Star | 变化 | 语言 | 一句话 |
| :-- | :-- | :-- | :-- | :-- | :-- |
| 1 | [**NandhaKishorM/laya**](https://github.com/NandhaKishorM/laya) `🆕` | ![](https://badgen.net/github/stars/NandhaKishorM/laya) | — | Python | Non-autoregressive System 1 decision engine. Typed choice, score and yes/no decisions over any… |
| 2 | [**browser-use/jev-ultrafast**](https://github.com/browser-use/jev-ultrafast) `🆕` | ![](https://badgen.net/github/stars/browser-use/jev-ultrafast) | ▲ 1006 | Python | Fastest and cheapest web agent |
| 3 | [**tamaratran/fast-jev-compaction**](https://github.com/tamaratran/fast-jev-compaction) `🆕` | ![](https://badgen.net/github/stars/tamaratran/fast-jev-compaction) | ▲ 268 | TS | Claude Code plugin that replaces the compaction summary with Jev decisions: every tool call and… |
| 4 | [**jaredpalmer/kev**](https://github.com/jaredpalmer/kev) `🆕` | ![](https://badgen.net/github/stars/jaredpalmer/kev) | ▲ 1739 | Python | tiny Jev-like family of decision models built on top of Qwen3.5 you can train and run on your o… |
| 5 | [**mizorewww/laya-mlx**](https://github.com/mizorewww/laya-mlx) `🆕` | ![](https://badgen.net/github/stars/mizorewww/laya-mlx) | ▲ 502 | Python | Native MLX runtime for Laya typed decision models — 7–14 ms short decisions on M3 Max. No text… |
| 6 | [**jev-chat/jev-chat-jarvis**](https://github.com/jev-chat/jev-chat-jarvis) `🆕` | ![](https://badgen.net/github/stars/jev-chat/jev-chat-jarvis) | ▲ 1414 | Kotlin | 装在手机上的对话副驾：在微信 / QQ / X / 飞书里读懂对方、给出候选回复、一键填入输入框，发不发由你。非侵入，只读屏幕，不 hook 不改包。 |
| 7 | [**TheoLeeCJ/SemIf-OpenJev**](https://github.com/TheoLeeCJ/SemIf-OpenJev) `🆕` | ![](https://badgen.net/github/stars/TheoLeeCJ/SemIf-OpenJev) | — | Python | Semantic ifs from open models, on a 3090 at home. Independent; not affiliated with Jev or TypeS… |
| 8 | [**jarrodwatts/jev-trader**](https://github.com/jarrodwatts/jev-trader) `🆕` | ![](https://badgen.net/github/stars/jarrodwatts/jev-trader) | ▲ 121 | TS | One AI trade decision every Monad block. Jev on Kuru MON-USDC. |
| 9 | [**TianyuCodings/NanoJev**](https://github.com/TianyuCodings/NanoJev) `🆕` | ![](https://badgen.net/github/stars/TianyuCodings/NanoJev) | ▲ 118 | Python | A nano replica of Jev: parallel decisions, dynamic candidates, and an end-to-end training pipel… |
| 10 | [**typesafe-ai/skills**](https://github.com/typesafe-ai/skills) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/skills) | ▲ 183 | — | Agent skills for building with TypeSafe's System One API |
| 11 | [**yibie/awesome-jev**](https://github.com/yibie/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/yibie/awesome-jev) | ▲ 181 | Python | A curated list of public projects, integrations, and discussions built on Jev — TypeSafe AI's S… |
| 12 | [**vinnylarouge/jevlike**](https://github.com/vinnylarouge/jevlike) `🆕` | ![](https://badgen.net/github/stars/vinnylarouge/jevlike) | ▲ 34 | Python | — |
| 13 | [**awlevin/typesafe-computer-use**](https://github.com/awlevin/typesafe-computer-use) `🆕` | ![](https://badgen.net/github/stars/awlevin/typesafe-computer-use) | ▲ 92 | Python | Computer use for about $0.0002 a step: OCR the screen, classify the next action with TypeSafe,… |
| 14 | [**heyjunpenn/awesome-jev**](https://github.com/heyjunpenn/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/heyjunpenn/awesome-jev) | ▲ 218 | Astro | A verified, community-maintained catalog of 834 open-source projects built with Jev. |
| 15 | [**githubnext/localjev**](https://github.com/githubnext/localjev) `🆕` | ![](https://badgen.net/github/stars/githubnext/localjev) | ▲ 5 | TS | — |
| 16 | [**kerpopule/hermes-jev-skills**](https://github.com/kerpopule/hermes-jev-skills) `🆕` | ![](https://badgen.net/github/stars/kerpopule/hermes-jev-skills) | ▲ 135 | Python | Jev-powered model routing, memory, compaction, skill selection, computer and browser use for He… |
| 17 | [**v-modal/awesome-jev-tools**](https://github.com/v-modal/awesome-jev-tools) `🆕` | ![](https://badgen.net/github/stars/v-modal/awesome-jev-tools) | ▲ 38 | — | A curated list of tools built for Jev — TypeSafe AI's System One model for typed decisions. |
| 18 | [**Sac-Y/Jev-cu**](https://github.com/Sac-Y/Jev-cu) `🆕` | ![](https://badgen.net/github/stars/Sac-Y/Jev-cu) | ▲ 10 | JS | — |
| 19 | [**wfzyx/von**](https://github.com/wfzyx/von) `🆕` | ![](https://badgen.net/github/stars/wfzyx/von) | ▲ 95 | Python | The open-source System One decision model. Sub-15ms, non-autoregressive, local drop-in alternat… |
| 20 | [**devagrawal09/jev-review**](https://github.com/devagrawal09/jev-review) `🆕` | ![](https://badgen.net/github/stars/devagrawal09/jev-review) | ▲ 33 | TS | A staged code-review workflow and local dashboard built with TypeSafe Jev. |
| 21 | [**thruwire/foreman**](https://github.com/thruwire/foreman) `🆕` | ![](https://badgen.net/github/stars/thruwire/foreman) | ▲ 19 | Python | Software factory foreman based on TypeSafe's Jev model |
| 22 | [**rmalde/minecraft-agent**](https://github.com/rmalde/minecraft-agent) `🆕` | ![](https://badgen.net/github/stars/rmalde/minecraft-agent) | ▲ 10 | JS | Astra planner and JEV controller for Minecraft, with native recording, tested routes, and run v… |
| 23 | [**featherless-ai/simple-jev**](https://github.com/featherless-ai/simple-jev) `🆕` | ![](https://badgen.net/github/stars/featherless-ai/simple-jev) | ▲ 17 | Python | Turn any open model into a classifier/jev endpoint |
| 24 | [**AbdelStark/awesome-typesafe-jev**](https://github.com/AbdelStark/awesome-typesafe-jev) `🆕` | ![](https://badgen.net/github/stars/AbdelStark/awesome-typesafe-jev) | ▲ 27 | HTML | Awesome Jev: a source-backed field guide to TypeSafe's System One model, with SDKs, live demos,… |
| 25 | [**wuyoscar/jev-skill**](https://github.com/wuyoscar/jev-skill) `🆕` | ![](https://badgen.net/github/stars/wuyoscar/jev-skill) | ▲ 32 | Python | An awesome collection of Jev use cases, workflows, and agent skills. |
| 26 | [**taeold/djev-run**](https://github.com/taeold/djev-run) `🆕` | ![](https://badgen.net/github/stars/taeold/djev-run) | ▲ 373 | HTML | — |
| 27 | [**logicrw/awesome-jev-projects**](https://github.com/logicrw/awesome-jev-projects) `🆕` | ![](https://badgen.net/github/stars/logicrw/awesome-jev-projects) | ▲ 60 | JS | Awesome Jev: source-backed open-source ecosystem radar, plain-language project discovery, and a… |
| 28 | [**jev-chat/jev-chat-windows**](https://github.com/jev-chat/jev-chat-windows) `🆕` | ![](https://badgen.net/github/stars/jev-chat/jev-chat-windows) | ▲ 177 | Python | 微信（Windows 4.x）旁挂的回复辅助：窗口截图 + 本地离线 OCR 读对方消息 → Jev 判断意图 → 3 条候选一键填入，发送永远手动 |
| 29 | [**superagents-lab/jev-search**](https://github.com/superagents-lab/jev-search) `🆕` | ![](https://badgen.net/github/stars/superagents-lab/jev-search) | ▲ 26 | TS | Search the web with TypeSafe's Jev: source selection, query understanding and relevance ranking… |
| 30 | [**wy-coliney/jev-browser-use**](https://github.com/wy-coliney/jev-browser-use) `🆕` | ![](https://badgen.net/github/stars/wy-coliney/jev-browser-use) | ▲ 58 | JS | 5–10x faster browser operations: Jev clicks, Codex thinks and verifies. Built at EZCollegeApp. |
| 31 | [**anishfn/shapeshift**](https://github.com/anishfn/shapeshift) `🆕` | ![](https://badgen.net/github/stars/anishfn/shapeshift) | — | TS | An input that becomes what you mean: one text box that morphs into the right UI as you type. Po… |
| 32 | [**kyotofin/tax-doc-classifier**](https://github.com/kyotofin/tax-doc-classifier) `🆕` | ![](https://badgen.net/github/stars/kyotofin/tax-doc-classifier) | ▲ 15 | TS | Tax document page classifier built on Jev decisions. 100% strict accuracy across 261 IRS forms,… |
| 33 | [**jerryjliu/docjev**](https://github.com/jerryjliu/docjev) `🆕` | ![](https://badgen.net/github/stars/jerryjliu/docjev) | ▲ 127 | Python | A very fast document classifier/splitter using Jev |
| 34 | [**Rizzo-AI-Academy/rizzo-flow**](https://github.com/Rizzo-AI-Academy/rizzo-flow) `🆕` | ![](https://badgen.net/github/stars/Rizzo-AI-Academy/rizzo-flow) | ▲ 44 | Python | The open, local take on Jev: typed decisions from an LLM, without generating a single token |
| 35 | [**nokia-applied-research/AnyJev**](https://github.com/nokia-applied-research/AnyJev) `🆕` | ![](https://badgen.net/github/stars/nokia-applied-research/AnyJev) | ▲ 337 | Python | Turn any LLM into a Jev-style decision model: typed decisions, real probabilities, no training.… |
| 36 | [**fhshaik/typesafe-mario**](https://github.com/fhshaik/typesafe-mario) `🆕` | ![](https://badgen.net/github/stars/fhshaik/typesafe-mario) | ▲ 26 | Python | A TypeSafe/Jev agent that plays Super Mario Bros. from structured emulator state. |
| 37 | [**dabit3/jev-experiments**](https://github.com/dabit3/jev-experiments) `🆕` | ![](https://badgen.net/github/stars/dabit3/jev-experiments) | ▲ 7 | TS | — |
| 38 | [**cobanov/awesome-jev**](https://github.com/cobanov/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/cobanov/awesome-jev) | ▲ 29 | — | A curated, source-backed list of projects built with Jev, TypeSafe AI's System One model for ty… |
| 39 | [**droidrun/mobile-jev**](https://github.com/droidrun/mobile-jev) `🆕` | ![](https://badgen.net/github/stars/droidrun/mobile-jev) | ▲ 22 | JS | — |
| 40 | [**razorback16/openjev**](https://github.com/razorback16/openjev) `🆕` | ![](https://badgen.net/github/stars/razorback16/openjev) | ▲ 57 | Python | Open, Jev-compatible System One decision server on DiffusionGemma |
| 41 | [**gargpratyush/jev-router**](https://github.com/gargpratyush/jev-router) `🆕` | ![](https://badgen.net/github/stars/gargpratyush/jev-router) | ▲ 27 | JS | Route to the cheapest model in claude code for your task using jev-router |
| 42 | [**receptron/laya**](https://github.com/receptron/laya) `🆕` | ![](https://badgen.net/github/stars/receptron/laya) | ▲ 66 | TS | Run Laya, the open-source Jev-compatible System-1 decision model, from Node.js / TypeScript via… |
| 43 | [**Mapika/decider**](https://github.com/Mapika/decider) `🆕` | ![](https://badgen.net/github/stars/Mapika/decider) | ▲ 26 | Python | A family of System One-style models fine-tuned from Qwen3.5, designed for one-pass typed decisi… |
| 44 | [**AnotiaWang/awesome-jev**](https://github.com/AnotiaWang/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/AnotiaWang/awesome-jev) | ▲ 35 | — | A curated list of awesome Jev / TypeSafe System One applications, libraries, and resources. |
| 45 | [**realZachi/pg-jev**](https://github.com/realZachi/pg-jev) `🆕` | ![](https://badgen.net/github/stars/realZachi/pg-jev) | ▲ 13 | Shell | Ask your Postgres tables questions in plain language. A PostgreSQL extension powered by TypeSaf… |
| 46 | [**jkudish/jev-mcp**](https://github.com/jkudish/jev-mcp) `🆕` | ![](https://badgen.net/github/stars/jkudish/jev-mcp) | ▲ 32 | JS | Fast, cheap, typed judgments from TypeSafe's Jev model, as MCP tools. |
| 47 | [**jev-chat/jev-chat-jarvis-mac**](https://github.com/jev-chat/jev-chat-jarvis-mac) `🆕` | ![](https://badgen.net/github/stars/jev-chat/jev-chat-jarvis-mac) | ▲ 125 | Python | 微信消息意图识别悬浮窗（macOS）：看屏 + 本地小模型判断意图和风险，再按话术生成回复候选。纯只读、不注入微信。 |
| 48 | [**ekzhang/openjev-sglang**](https://github.com/ekzhang/openjev-sglang) `🆕` | ![](https://badgen.net/github/stars/ekzhang/openjev-sglang) | ▲ 36 | Python | Jev-compatible API endpoint based on open models (prefill-only) |
| 49 | [**Zefan-Cai/Open-Jev**](https://github.com/Zefan-Cai/Open-Jev) `🆕` | ![](https://badgen.net/github/stars/Zefan-Cai/Open-Jev) | ▲ 83 | Python | — |
| 50 | [**typesafe-ai/system-one-adapter-python**](https://github.com/typesafe-ai/system-one-adapter-python) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/system-one-adapter-python) | ▲ 19 | Python | Drop-in TypeSafeClient replacement backed by LLM APIs |
| 51 | [**itsmostafa/typesafe-mcp**](https://github.com/itsmostafa/typesafe-mcp) `🆕` | ![](https://badgen.net/github/stars/itsmostafa/typesafe-mcp) | ▲ 25 | Go | An mcp connector to evaluate anything fast and cheap. Give your AI agent direct access to types… |
| 52 | [**sutro-sh/jev-align**](https://github.com/sutro-sh/jev-align) `🆕` | ![](https://badgen.net/github/stars/sutro-sh/jev-align) | ▲ 8 | Python | Build calibrated AI Functions from human feedback using Jev and GEPA. |
| 53 | [**Heman10x-NGU/openJev-verdict-2.0**](https://github.com/Heman10x-NGU/openJev-verdict-2.0) `🆕` | ![](https://badgen.net/github/stars/Heman10x-NGU/openJev-verdict-2.0) | ▲ 12 | Python | Calibrated 151M Non-Autoregressive Decision Engine beating TypeSafe Jev & Laya on LocalLLaMA/ty… |
| 54 | [**malevrigns/agent-jev**](https://github.com/malevrigns/agent-jev) `🆕` | ![](https://badgen.net/github/stars/malevrigns/agent-jev) | ▲ 58 | Python | AgentJev-0.6B - a fast 'System One' decision model for AI Agents: feed it any unstructured stat… |
| 55 | [**Yinsongxu/LLM2Jev**](https://github.com/Yinsongxu/LLM2Jev) `🆕` | ![](https://badgen.net/github/stars/Yinsongxu/LLM2Jev) | ▲ 132 | Python | Turn local language models into Jev-style structured decision models. Get results from text and… |
| 56 | [**kydlikebtc/awesome-jev**](https://github.com/kydlikebtc/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/kydlikebtc/awesome-jev) | ▲ 185 | Python | 805 verified examples of Jev — TypeSafe AI's System One decision model — indexed by the decisio… |
| 57 | [**moritzkremb/jev-voice-browser**](https://github.com/moritzkremb/jev-voice-browser) `🆕` | ![](https://badgen.net/github/stars/moritzkremb/jev-voice-browser) | ▲ 20 | JS | Control a real browser by voice. Jev (TypeSafe System One) decides intent + target in ~300 ms p… |
| 58 | [**hr98w/jev-visual**](https://github.com/hr98w/jev-visual) `🆕` | ![](https://badgen.net/github/stars/hr98w/jev-visual) | ▲ 19 | Python | An educational Jev-like visual inference experiment on Apple Silicon: shared context, direct ca… |
| 59 | [**OmniJev/awesome-jev-gallery**](https://github.com/OmniJev/awesome-jev-gallery) `🆕` | ![](https://badgen.net/github/stars/OmniJev/awesome-jev-gallery) | ▲ 57 | JS | Papers, open reproductions and independent evaluations behind System One models and Jev. |
| 60 | [**0xNatoshi/jev-codex-router**](https://github.com/0xNatoshi/jev-codex-router) `🆕` | ![](https://badgen.net/github/stars/0xNatoshi/jev-codex-router) | ▲ 32 | JS | Per-turn model & reasoning routing for Codex, driven by Jev (TypeSafe System One): picks the mo… |
<!-- HOT:END -->
